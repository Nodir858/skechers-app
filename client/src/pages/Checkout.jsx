...
const Checkout = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div
      ...
      className="fixed top-0 right-0 h-full lg:min-w-[25rem] bg-white duration-300 transition-transform ease-in-out shadow-2xl"
    >
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="overflow-y-auto max-h-[60vh]">
            {cartItems.map((item, key) => (
              <div
                key={key}
                className="flex flex-col items-center md:items-center md:flex-row justify-around mb-2 font-medium shadow-md "
              >
                <div>
                  <span>
                    <FaTimes
                  ...
                  <img
                    ...
                    height={128}
                    width={128}
                    className=" w-60 md:h-[128px] md:w-[128px]"
                  />
                  {/* <span>FaTimes</span> */}
                </div>
